...
const defaultProducts = [
  ...
  {id:7, title:'بكيني باتر', price:85, desc:'بكيني باتر ملح الحليب الاماراتي تفتيح وتعطير ثابت معاكي 5 ايام ف الجسم لكل الجسم حرفيا' , img:'images/product7.jpeg'},
  {id:8, title:'كريم البوش اب ',price: 85, desc:'كريم البوش اب بديل الفيلر لنفخ الخدود و الشفايف واي منطقه من مناطق الانوثه', img:'images/product8.jpeg'},
  {id:9, title:'كريم سيرافي ',price:85, desc:'هو مرطب يومي للوجه والجسم ويمكن استخدامه علي البشره الجافه الي الجافه جدا ', img:'images/product9.jpeg'},
  {id:10, title:'غسول البشره من فيتشي ',price:80 , desc:'الغسول يحتوي علي الساليسيليك اسيد يعني بشرتك هتكون نضيفه من الرؤوس السوداء والبيضاء بيقلل المسام وبتلاحظي فيه لامعه بالبشره من اول مره بتجربيه بتلاحظي الفروق وكمان يعادل دهنيه البشره ويجفف حب الشباب', img:'images/product10.jpeg'},
